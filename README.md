VisualFreeBasic(简称VFB)是勇芳工作室基于FreeBasic开发的开发环境(http://www.yfvb.com/)，使用 FreeBasic 语言（语法和 VisualBasic6 一样，扩展了高级功能和系统底层处理能力，和C语言一样强大，编程方法和 VisualBasic6 一样简单易用）<br />
